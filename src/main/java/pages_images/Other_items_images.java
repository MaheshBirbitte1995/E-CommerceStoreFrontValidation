...
public class Other_items_images {
	...
	public Other_items_images(WebDriver driver) {
	...
	public void Other_items_images_count() throws InterruptedException {
		...
		driver.findElement(By.xpath("//a[@title='Other Items']")).click();
		Thread.sleep(2000) ;
