...
public class Liquor_and_spirits_images {
	...
	public Liquor_and_spirits_images(WebDriver driver) {
		this.driver=driver;
	    ...
	    public  void Liquor_and_spirits_images_count() throws InterruptedException {
